...
public class SpeechActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(org.tensorflow.demo.R.layout.activity_speech);
    quitButton = (Button) findViewById(org.tensorflow.demo.R.id.quit);
    ...
    labelsListView = (ListView) findViewById(org.tensorflow.demo.R.id.list_view);
    ...
    ArrayAdapter<String> arrayAdapter =
        new ArrayAdapter<String>(this, org.tensorflow.demo.R.layout.list_text_item, displayedLabels);
                ...
                AnimatorSet colorAnimation =
                    (AnimatorSet)
                        AnimatorInflater.loadAnimator(
                            SpeechActivity.this, org.tensorflow.demo.R.animator.color_animation);
