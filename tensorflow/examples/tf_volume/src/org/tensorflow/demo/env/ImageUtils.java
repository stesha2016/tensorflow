...
public class ImageUtils {
  ...
  public static int mPixelPerDist = 0;
  private static int pipefd = 0;
  ...
  //Add by stesha start
  public static void startDistanceReader() {
    try {
      pipefd = ImageUtils.startGridCamReader();
    } catch (UnsatisfiedLinkError e) {
      LOGGER.w(
          "Call JNI startGridCamReader failed.");
    }
  }

  public static int getDistancePixel() {
    try {
      mPixelPerDist = ImageUtils.getGridCamPixel();
      return mPixelPerDist;
    } catch (UnsatisfiedLinkError e) {
      LOGGER.w(
          "Call JNI getDistancePixel failed.");
      return 0;
    }
  }

  public static void stopDistanceReader() {
    try {
      ImageUtils.stopGridCamReader();
      return;
    } catch (UnsatisfiedLinkError e) {
      LOGGER.w(
          "Call JNI stopGridCamReader failed.");
    }
  }

  private static native int startGridCamReader();
  private static native int getGridCamPixel();
  private static native void stopGridCamReader();
  //Add by stesha end
